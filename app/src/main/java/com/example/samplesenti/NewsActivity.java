...
public class NewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queue = Volley.newRequestQueue(this);//requestqueue를 초기화 Volley한테 네트워크 연결 request요청
        getNews();//뉴스 정보를 받아온다
    ...
    public void getNews(){//json를 활용해 정보를 받아오는 함수
        ...
        String url ="https://newsapi.org/v2/everything?q=%EB%B2%94%ED%96%89%0A&sortby=publishedat&apiKey=81fce0774dc242a09cba4d1e1557fdfc";//접속할 사이트
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mAdapter = new MyAdapter(news,NewsActivity.this);//액티비티가 원본 데이터를 어댑터로 넘겨주고 어댑터는 이것을 활용
