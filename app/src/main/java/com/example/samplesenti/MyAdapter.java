...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public MyAdapter(List<NewsData> myDataset, Context context) {//mDataset: 각 줄마다 보여줄 값을 들고있는 원본 데이터 변수 (다양한 변수로 설정가능)
        mDataset = myDataset;
    ...
    @Override
    public MyAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,//RecyvlerView의 항목화면 연결은 onCreateViewHolder
                                                     int viewType) {
        // create a new view
